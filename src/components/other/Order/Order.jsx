...
import { orderAddress, orderAgreement, orderPhone, orderRequest } from '../../../actions/actionCreator';
...
export default function Order() {
  ...
  async function setOrder() {
    dispatch(orderRequest(orderState.phone, orderState.address, cartState.cart));
  }
  ...
  return (
    (orderState.operationResult) ? (
      ...
      <section className="order">
        {orderState.loadingStatus && <Loader />}
