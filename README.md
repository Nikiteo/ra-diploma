[![Build status](https://ci.appveyor.com/api/projects/status/2ybd1krms2mfabnd?svg=true)](https://ci.appveyor.com/project/Nikiteo/ra-diploma)

## Демо
https://nikiteo.github.io/ra-diploma
...
![Header](./public/header-menu.png)

![Footer](./public/footer-menu.png)
...
![Frontpage](./public/index-loading.png)
...
![Frontpage](./public/index-loaded.png)

Общая схема:

![Frontpage](./public/index-loaded-comments.png)
...
![Search](./public/search-comments.png)

По умолчанию поисковое поле скрыто, отображается только иконка:

![Search](./public/search-closed.png)
...
![Search](./public/search-catalog-comments.png)
...
![Item](./public/catalog-item-comments.png)
